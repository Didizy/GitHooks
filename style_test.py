...
client = Client()
auth = client.login("test1", "aaa")



# client.add_task("test1", auth, "task_test")
# client.delete_task(auth, "10")
client.update_task(auth, "new_task", "9")
# client.task_list("test1", auth)